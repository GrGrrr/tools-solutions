...
export const AwardsSection = () => {
    return (
        <div className="sm:px-[20px] sm:py-[80px] 3xl:px-[64px] 3xl:py-[160px] 4xl:px-[100px] bg-base-weak">
            <span className="sm:hidden 3xl:text-desktop-title-md 3xl:block text-base-strong uppercase">Celebrating Our Milestones</span>
            <span className="sm:text-mobile-title-lg sm:block 3xl:hidden text-base-strong uppercase">Celebrating <br/>Our Milestones</span>
            <p className="sm:text-mobile-text-lg 3xl:text-desktop-text-md text-base-strong mt-[64px] sm:pb-[60px] 3xl:pb-[80px] 3xl:mr-[80px]">Tools
                & Solutions’
            ...
            <div
                className="sm:flex sm:flex-col sm:pt-[60px] 3xl:grid 3xl:grid-cols-3 3xl:gap-[20px] 3xl:pt-[80px] border-t-[1px] border-smoke-weak">
                ...
                <div className="sm:mb-[80px]">
                    ...
                    <span
                        className="sm:text-mobile-subtitle 3xl:text-desktop-subtitle text-base-strong sm:mr-[40px] 3xl:mr-[20px]">Gulf Business Excellence Award</span>
                    <p className="sm:text-mobile-text-md 3xl:text-desktop-text-md text-smoke-strong mt-[20px]">Recognized
                        for our innovative
                ...
                <div>
                    ...
                    <span
                        className="sm:text-mobile-subtitle 3xl:text-desktop-subtitle text-base-strong sm:mr-[40px] 3xl:mr-[20px]">Saudi Arabian Innovation Award</span>
                    <p className="sm:text-mobile-text-md 3xl:text-desktop-text-md text-smoke-strong mt-[20px]">Honored
