    ...
    return (
        <div className="3xl:pl-[64px] 3xl:grid 3xl:grid-cols-2 sm:flex sm:flex-col bg-base-weak shadow-slider">
            <div className="sm:pt-[60px] sm:px-[20px] 3xl:pt-[80px] 3xl:mr-[80px]">
                ...
                <span className="sm:text-mobile-title-sm sm:block 3xl:hidden text-base-strong">The Power of <br/>Intelligent&nbsp;Insights</span>
                <p className="sm:text-desktop-text-md 3xl:text-desktop-text-md text-base-strong sm:mt-[40px] sm:mb-[60px] 3xl:mt-[80px]">We turn raw data into actionable
