            ...
            <div className="3xl:grid 3xl:grid-cols-2 sm:pt-[40px] 3xl:pt-[80px]">
                <div className="3xl:grid 3xl:grid-cols-2">
                    <div className="flex gap-x-12 flex-col">
                        ...
                        <a href="#"
                           className="sm:text-mobile-text-md 3xl:text-desktop-text-md text-base-weak mt-[10px]">Reports
                            & Publications</a>
                    </div>
                    <div className="flex gap-x-12 flex-col">
                        <a href="#"
                           className="sm:text-mobile-text-md 3xl:text-desktop-text-md text-base-weak sm:mt-[30px] 3xl:mt-0">News
                            & Media</a>
                        <a href="#"
                           className="sm:text-mobile-text-md 3xl:text-desktop-text-md text-base-weak mt-[10px]">Blog</a>
                        <a href="#"
                           className="sm:text-mobile-text-md 3xl:text-desktop-text-md text-base-weak mt-[10px]">Careers</a>
                        <a href="#"
                           className="sm:text-mobile-text-md 3xl:text-desktop-text-md text-base-weak mt-[10px]">Contact
                            Us</a>
                    </div>
                </div>
            ...
            <div className="sm:pt-[40px] 3xl:grid 3xl:grid-cols-2 3xl:pt-[80px]">
                ...
                <div className="flex items-end justify-between sm:pt-[40px]">
                    ...
                    <button onClick={handleToTop}>
                        <span
                            className="sm:text-mobile-text-sm 3xl:text-desktop-text-sm text-base-weak">Back to top ↑</span>
                    </button>
                </div>
            </div>
        </div>
